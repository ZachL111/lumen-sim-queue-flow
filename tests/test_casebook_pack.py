"""Regression checks for the lumen-sim-queue-flow casebook."""
...
from casebook.harness import assert_expected, lumen_sim_queue_flow_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(lumen_sim_queue_flow_summary(), assert_expected())
